...
const Pagination: React.FC<PaginationProps> = ({ totalCount, limit, idElementToScrollTo }) => {
  ...
  return isMobile ? (
    <PagerMobile totalCount={totalCount} limit={limit} idElementToScrollTo={idElementToScrollTo} />
  ) : (
    <Pager totalCount={totalCount} limit={limit} idElementToScrollTo={idElementToScrollTo} />
  )
}
