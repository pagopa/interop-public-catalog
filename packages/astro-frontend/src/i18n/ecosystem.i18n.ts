...
export const ecosystem = {
  it: {
    ...
    "ecosystem.image_alt":
      "Schema dell’interoperabilità della Pubblica Amministrazione: Catalogo della Semantica, la Piattaforma Digitale Nazionale Dati e gli enti pubblici collaborano per fornire servizi ai cittadini.",
  ...
  en: {
    ...
    "ecosystem.image_alt":
      "Interoperability framework of the Public Administration: National Data Catalog, the National Data Platform and organizations collaborate, within the European framework, to provide integrated services to citizens.",
