...
} from "../components/shared/EServiceCard";
...
export const AccessReserved: Story = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        story:
          "Stato di default con badge di accesso riservato e testo in italiano.",
      },
    },
  },
};
...
export const OpenData: Story = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        story:
          "Badge Open Data e testo breve per evidenziare lo stato pubblico della risorsa.",
      },
    },
  },
};
