...
import { GoodPracticeCard, GoodPracticeCardSkeleton } from '../components/shared/GoodPracticeCard'
...
export const MultipleTargets: Story = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        story: 'Card con più categorie di destinatari target che vengono concatenate.',
      },
    },
  },
}
...
export const NoTargets: Story = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        story: 'Card senza destinatari specifici, mostra "Tutti" come fallback.',
      },
    },
  },
}
...
export const LongTitle: Story = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        story: 'Card con titolo lungo per testare il layout e il wrapping del testo.',
      },
    },
  },
}
...
export const Skeleton: Story = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        story: 'Versione skeleton per il loading state con placeholder animati.',
      },
    },
  },
}
