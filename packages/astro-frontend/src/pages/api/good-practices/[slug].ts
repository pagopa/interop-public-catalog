...
import { emptyErrorMapper, GoodPractice, notFoundError } from 'pagopa-interop-public-models'
...
export const GET: APIRoute = async ({ params, url, locals }) => {
  try {
    ...
    locals.logger.info(`Fetching good practice by slug: ${slug}, Locale: ${locale}`)
